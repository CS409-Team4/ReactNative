/* Code source from 'react-native-sortable-listview' package
 * Modified only a few parts from the original source
 */
...
var Row = React.createClass({
    ...
    render: function() {
        ...
        let Row = React.cloneElement(this.props.renderRow(this.props.rowData.data, this.props.rowData.section, this.props.rowData.index, null, this.props.active), {sortHandlers: {onPressIn: this.handleLongPress, onPressOut: this.props.list.cancel}, onLongPress: this.handleLongPress, onPressOut: this.props.list.cancel});
